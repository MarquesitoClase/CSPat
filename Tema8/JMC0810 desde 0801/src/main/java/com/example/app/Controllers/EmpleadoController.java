...
public class EmpleadoController {
    ...
    public String showEditSubmit(@Valid Empleado empleadoForm, BindingResult bindingResult) {
        ...
        @Parameter( description = "En el propio path, va el id del empleado que queremos que se borre", example = "/borrar/11")
        public String showDelete(@PathVariable long id) {
            empleadoService.borrar(id);
            return "redirect:/list";
        }
        @GetMapping("/porNombre")
        @Parameter(name = "nombre", description = "El nombre que queremos buscar entre los de los clientes", example = "Pepe", required = true)
