...
Departamento desarrollo = new Departamento(0, "Desarrollo", "Crear apps nuevas");
return args -> {
	empleadoService.añadir(new Empleado(1L, "pepe", desarrollo, "pepe@gmail.com", 1000d, true, Genero.MASCULINO));
};
}
}
